...
\begin{tcolorbox}[title=Enunciado, colback=blue!5!white, colframe=blue!75!black]
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item Faça a simulação por forma de onda funcional e temporal com o programa de1.s, corrigindo todos os hazards no programa apenas com a inserção de bolhas (nop), mostrando o funcionamento correto da CPU. 
