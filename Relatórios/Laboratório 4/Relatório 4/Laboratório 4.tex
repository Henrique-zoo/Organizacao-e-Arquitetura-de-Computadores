...
\paragraph{(b)} Compilando o projeto no Quartus, os requisitos físicos encontrados foram: 2.918 elementos lógicos; 1.317 registradores; 108 pinos; e memória total de 65.536 bits. Além disso, a partir do \textit{Timing Analyzer}, ferramenta do  \textit{software} da Altera, encontramos os seguintes requisitos temporais: \textit{slack} de \textit{setup} de 1,587 ns; \textit{slack} de \textit{hold} de 2,784 ns.
...
\begin{equation*}
    t_{\mathrm{exec}} = \mathrm{I} \times \mathrm{CPI} \times \mathrm{T}_{\mathrm{clock}}
\end{equation*}
...
Todos os códigos desenvolvidos para a realização desse laboratório foram enviados compactados em um arquivo \cod{.zip}. Para acessar o vídeo solicitado, \href{https://www.youtube.com/watch?v=oISrELfP-Hw}{\textcolor{azul_link}{\underline{clique aqui}}}.
\end{document}